 ...
 */
public class DbDBFluteConfig {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    /** The logger instance for this class. (NotNull) */
    private static final Logger _log = LoggerFactory.getLogger(DbDBFluteConfig.class);

    /** Singleton instance. */
    private static final DbDBFluteConfig _instance = new DbDBFluteConfig();
     ...
     * Constructor.
     */
    private DbDBFluteConfig() { // adjusts default settings
     ...
     */
    public static DbDBFluteConfig getInstance() {
        return _instance;
    }
