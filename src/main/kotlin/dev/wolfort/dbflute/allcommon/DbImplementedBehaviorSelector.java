 ...
 */
public class DbImplementedBehaviorSelector implements BehaviorSelector {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    /** The logger instance for this class. (NotNull) */
    private static final Logger _log = LoggerFactory.getLogger(DbImplementedBehaviorSelector.class);
    ...
    public void initializeConditionBeanMetaData() {
        final Map<String, DBMeta> dbmetaMap = DbDBMetaInstanceHandler.getUnmodifiableDBMetaMap();
    ...
    public BehaviorReadable byName(String tableFlexibleName) {
        ...
        final DBMeta dbmeta = DbDBMetaInstanceHandler.findDBMeta(tableFlexibleName);
