 ...
 */
public class DbImplementedInvokerAssistant implements InvokerAssistant {
    ...
    protected DbDBFluteInitializer _introduction;
    ...
    public DBDef assistCurrentDBDef() {
        return DbDBCurrent.getInstance().currentDBDef();
    }
    ...
    public DataSource assistDataSource() { // DI component
        ...
        DataSourceHandler handler = DbDBFluteConfig.getInstance().getDataSourceHandler();
    ...
    protected DbImplementedSqlClauseCreator newImplementedSqlClauseCreator() {
        return new DbImplementedSqlClauseCreator();
    }
    ...
    protected StatementFactory createStatementFactory() {
        ...
        DbDBFluteConfig config = DbDBFluteConfig.getInstance();
    ...
    protected TnBeanMetaDataFactory createBeanMetaDataFactory() {
        ...
        factory.setInternalDebug(DbDBFluteConfig.getInstance().isInternalDebug());
        return factory;
    }
    ...
    protected OutsideSqlExecutorFactory createOutsideSqlExecutorFactory() {
        OutsideSqlExecutorFactory factory = DbDBFluteConfig.getInstance().getOutsideSqlExecutorFactory();
        if (factory != null) {
            return factory;
        }
    ...
    protected SQLExceptionDigger createSQLExceptionDigger() {
        return DbDBFluteConfig.getInstance().getSQLExceptionDigger();
    }
    ...
    protected SequenceCacheHandler createSequenceCacheHandler() {
        ...
        SequenceCacheKeyGenerator generator = DbDBFluteConfig.getInstance().getSequenceCacheKeyGenerator();
        if (generator != null) {
            handler.setSequenceCacheKeyGenerator(generator);
        }
        handler.setInternalDebug(DbDBFluteConfig.getInstance().isInternalDebug());
        return handler;
    }
    ...
    public StatementConfig assistDefaultStatementConfig() {
        return DbDBFluteConfig.getInstance().getDefaultStatementConfig();
    }
    ...
    public GearedCipherManager assistGearedCipherManager() {
        return DbDBFluteConfig.getInstance().getGearedCipherManager();
    }
    ...
    public void setIntroduction(DbDBFluteInitializer introduction) {
