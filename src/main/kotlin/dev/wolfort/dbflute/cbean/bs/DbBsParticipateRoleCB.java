...
/**
 * The base condition-bean of participate_role.
 * @author DBFlute(AutoGenerator)
 */
public class DbBsParticipateRoleCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected DbParticipateRoleCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public DbBsParticipateRoleCB() {
     ...
     * @return this. (NotNull)
     */
    public DbParticipateRoleCB acceptPK(Integer participateRoleId) {
        assertObjectNotNull("participateRoleId", participateRoleId);
        DbBsParticipateRoleCB cb = this;
        cb.query().setParticipateRoleId_Equal(participateRoleId);
        return (DbParticipateRoleCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_ParticipateRoleId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_ParticipateRoleId_Desc();
        return this;
    }
     ...
     */
    public DbParticipateRoleCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public DbParticipateRoleCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected DbParticipateRoleCQ doGetConditionQuery() {
    ...
    protected DbParticipateRoleCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected DbParticipateRoleCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        DbParticipateRoleCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected DbParticipateRoleCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new DbParticipateRoleCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<DbParticipateRoleCB> unionCBLambda) {
        final DbParticipateRoleCB cb = new DbParticipateRoleCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final DbParticipateRoleCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<DbParticipateRoleCB> unionCBLambda) {
        final DbParticipateRoleCB cb = new DbParticipateRoleCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final DbParticipateRoleCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">participateRoleBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">participateRole</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">participateRole</span>.<span style="color: #CC4747">getParticipate()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<DbParticipateRoleCQ> {
        protected DbParticipateCB.HpSpecification _participate;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<DbParticipateRoleCQ> qyCall
         ...
         */
        public SpecifiedColumn columnParticipateRoleId() { return doColumn("participate_role_id"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "participate_role"; }
        /**
         ...
         */
        public HpSDRFunction<DbParticipateRoleCB, DbParticipateRoleCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<DbParticipateRoleCB> sq, DbParticipateRoleCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public DbParticipateRoleCB dreamCruiseCB() {
        DbParticipateRoleCB cb = new DbParticipateRoleCB();
        cb.xsetupForDreamCruise((DbParticipateRoleCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<DbParticipateRoleCB> columnQuery(final SpecifyQuery<DbParticipateRoleCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected DbParticipateRoleCB xcreateColumnQueryCB() {
        DbParticipateRoleCB cb = new DbParticipateRoleCB();
        cb.xsetupForColumnQuery((DbParticipateRoleCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<DbParticipateRoleCB> orCBLambda) {
        xorSQ((DbParticipateRoleCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<DbParticipateRoleCB> andCBLambda) {
        xorSQAP((DbParticipateRoleCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final DbParticipateRoleCB cb;
        if (mainCB != null) {
            cb = (DbParticipateRoleCB)mainCB;
        } else {
            cb = new DbParticipateRoleCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return DbParticipateRoleCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return DbParticipateRoleCQ.class.getName(); }
