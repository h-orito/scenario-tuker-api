...
import dev.wolfort.dbflute.cbean.cq.bs.DbBsUserCQ;
 ...
 */
public class DbUserCQ extends DbBsUserCQ {
     ...
     */
    public DbUserCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
