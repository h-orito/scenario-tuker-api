...
public abstract class DbBsParticipateBhv extends AbstractBehaviorWritable<DbParticipate, DbParticipateCB> {
    ...
    /**
     * Pull out the list of referrer-as-one table 'DbParticipateImpression'.
     * @param participateList The list of participate. (NotNull, EmptyAllowed)
     * @return The list of referrer-as-one table. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<DbParticipateImpression> pulloutParticipateImpressionAsOne(List<DbParticipate> participateList)
    { return helpPulloutInternally(participateList, "participateImpressionAsOne"); }
