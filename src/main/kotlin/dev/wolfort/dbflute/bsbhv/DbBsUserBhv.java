...
public abstract class DbBsUserBhv extends AbstractBehaviorWritable<DbUser, DbUserCB> {
     ...
     * <pre>
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">loadUserRuleBook</span>(<span style="color: #553000">userList</span>, <span style="color: #553000">bookCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<DbUserRuleBook> loadUserRuleBook(List<DbUser> userList, ReferrerConditionSetupper<DbUserRuleBookCB> refCBLambda) {
        xassLRArg(userList, refCBLambda);
        return doLoadUserRuleBook(userList, new LoadReferrerOption<DbUserRuleBookCB, DbUserRuleBook>().xinit(refCBLambda));
    }
     ...
     * USER_RULE_BOOK by user_id, named 'userRuleBookList'.
     * <pre>
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">loadUserRuleBook</span>(<span style="color: #553000">user</span>, <span style="color: #553000">bookCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">bookCB</span>.setupSelect...
     *     <span style="color: #553000">bookCB</span>.query().set...
     *     <span style="color: #553000">bookCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">user</span>.<span style="color: #CC4747">getUserRuleBookList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<DbUserRuleBook> loadUserRuleBook(DbUser user, ReferrerConditionSetupper<DbUserRuleBookCB> refCBLambda) {
        xassLRArg(user, refCBLambda);
        return doLoadUserRuleBook(xnewLRLs(user), new LoadReferrerOption<DbUserRuleBookCB, DbUserRuleBook>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<DbUserRuleBook> doLoadUserRuleBook(List<DbUser> userList, LoadReferrerOption<DbUserRuleBookCB, DbUserRuleBook> option) {
        return helpLoadReferrerInternally(userList, option, "userRuleBookList");
    }
     ...
     * <pre>
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">loadUserScenario</span>(<span style="color: #553000">userList</span>, <span style="color: #553000">scenarioCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<DbUserScenario> loadUserScenario(List<DbUser> userList, ReferrerConditionSetupper<DbUserScenarioCB> refCBLambda) {
        xassLRArg(userList, refCBLambda);
        return doLoadUserScenario(userList, new LoadReferrerOption<DbUserScenarioCB, DbUserScenario>().xinit(refCBLambda));
    }
     ...
     * USER_SCENARIO by user_id, named 'userScenarioList'.
     * <pre>
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">loadUserScenario</span>(<span style="color: #553000">user</span>, <span style="color: #553000">scenarioCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">scenarioCB</span>.setupSelect...
     *     <span style="color: #553000">scenarioCB</span>.query().set...
     *     <span style="color: #553000">scenarioCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">user</span>.<span style="color: #CC4747">getUserScenarioList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<DbUserScenario> loadUserScenario(DbUser user, ReferrerConditionSetupper<DbUserScenarioCB> refCBLambda) {
        xassLRArg(user, refCBLambda);
        return doLoadUserScenario(xnewLRLs(user), new LoadReferrerOption<DbUserScenarioCB, DbUserScenario>().xinit(refCBLambda));
    }

    protected NestedReferrerListGateway<DbUserScenario> doLoadUserScenario(List<DbUser> userList, LoadReferrerOption<DbUserScenarioCB, DbUserScenario> option) {
        return helpLoadReferrerInternally(userList, option, "userScenarioList");
    }
